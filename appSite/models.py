...
from aaBase.search import search_article_new,search_article_hot,table_to_datas,datas_to_table
import datetime
...
class Nav(models.Model):
    ...
    subNavs = models.ManyToManyField(to='appSite.Nav',related_name='superNav',verbose_name='子标题',null=True,blank=True)
